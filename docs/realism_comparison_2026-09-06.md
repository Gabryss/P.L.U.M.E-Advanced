...
![Original contours versus cuts through the generated mesh](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/mesh_section_check.png)
...
**Reproduction and artifacts.** Fresh network diagnostics are in [current_earth](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/current_earth/summary.json). Numerical comparisons, config/source fingerprints and the isolated meshing check are in [comparison_metrics.json](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/comparison_metrics.json); all generated contour measurements are in [generated_contour_metrics.csv](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/generated_contour_metrics.csv). The bounded mesh is [isolated_segment.ply](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/isolated_segment.ply).

Run `scripts/generate_network_diagnostics.py --output outputs/realism_comparison/current_earth --density-sweep ''` using the project environment, followed by [analyze_comparison.py](/home/gabriel/Lab/python/P.L.U.M.E-Advanced/outputs/realism_comparison/analyze_comparison.py). These are exploratory analyses, not a rerun of the full confirmatory benchmark or all export targets.
